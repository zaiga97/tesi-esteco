...
class Trainer:
    ...
    def __init__(self, actor: Actor, env, env_test, algo, log_dir, seed=0, num_steps=10 ** 5,
    ...
    def evaluate(self, step):
        ...
        for _ in range(self.num_eval_episodes):
            ...
            mean_len += episode_len / self.num_eval_episodes

        self.writer.add_scalar('test/return', mean_return, step)
        self.writer.add_scalar('test/ep_len', mean_len, step)
